        ...
        return (
            <div className='projectsContainer'>
                ...
                <div className='project1'>
                    ...
                    <br/>
                    {/* <a href="" className='projectLinks'>Check It Out</a> */}

                    <p className='text'>This application gives the user a chance to record everything they would need to remember about their dreams</p>
                </div>
                <div className='project2'>
                    ...
                    <p className='text'>This application provides the user with selective information about their own zodiac sign</p>
                </div>
                <div className='project3'>
                    ...
                    <p className='text'>This application tells the user of my own personal favorites in my chosen categories and asks for the users as well</p>
